...
def test_main(MyUniswapExchangeAdd, MyUniswapExchangeRemove, MyCurveExchangeAdd, UniswapV2Router02, UniswapV2Factory, DAI, USDC, USDT, WETH, WBTC, crvLpToken, accounts, Contract):
    coins = [
