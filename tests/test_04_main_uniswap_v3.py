...
def test_main(DAI, WETH, accounts, UniswapV2Router02, MyUniswapV3ExchangeAdd, Contract):
    ...
    uniV3Params = [DAI, WETH, 3000, -120000, 120000, 0, accounts[0], 2 ** 256 - 1]
    MyUniswapV3ExchangeAdd.investTokenForUniPair("0x0000000000000000000000000000000000000000", 10 ** 18, 0, uniV3Params, {"from":accounts[0], "value": 1005 * 10 ** 15})
