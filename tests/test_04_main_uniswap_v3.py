...
def test_main(DAI_R, WETH_R, accounts, Contract):
    ...
    print(WETH.balanceOf(MyNonfungiblePositionManager))
    print(DAI.balanceOf(MyNonfungiblePositionManager))
    uniV3Params = [WETH, DAI, 3000, 75480, 77820, 0xde0b6b3a7640000, 0x589e0711a7a67c59f8, 0, 0, accounts[0], 2 ** 256 - 1]
    WETH.approve(MyUniswapV3ExchangeAdd, 0xde0b6b3a7640000, {"from": accounts[0]})
    DAI.approve(MyUniswapV3ExchangeAdd, 0x589e0711a7a67c59f8, {"from": accounts[0]})
